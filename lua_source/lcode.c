...
static int constfolding (OpCode op, expdesc *e1, expdesc *e2) {
  ...
  switch (op) {
    ...
    case OP_BOR: luai_binor(r, v1, v2); break;
    case OP_BAND: luai_binand(r, v1, v2); break;
    case OP_BXOR: luai_binxor(r, v1, v2); break;
    case OP_BRSHFT: luai_binrshft(r, v1, v2); break;
    case OP_BLSHFT: luai_binlshft(r, v1, v2); break;
    //case OP_BNOT: luai_binnot(r, v1); break;
#endif
